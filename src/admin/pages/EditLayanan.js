                                    ...
                                    <div className="card-body">
                                        <form>
                                            <div className="form-row mt-3">
                                                ...
                                                <input id='poliklinik' type="text" placeholder='Nama Poliklinik' value='Nama Poliklinik' className="form-control col-md-9" />
                                            </div>
                                            <div className="form-row mt-3">
                                                <label className="col-md-3">Kode Poli <span className='text-danger'>*</span></label>
                                                <input id='kode' type="number" placeholder='Kode Poliklinik' value='999' className="form-control col-md-9" />
                                            </div>
                                        </form>
